...
//   const { fetchOrders, fetchedOrders, updateStatus } =
//     useSellerActionsContext();
...
//                     className="h-[30px] w-[100px] py-0 text-base border-[1px]"
//                   >
//                     {isOpen ? "Cancel" : "Update"}
//                   </CustomButton>
//                   {isOpen && (
//                     <div className="absolute bottom-0 right-[40%] bg-black ">
//                       <button
//                         onClick={(e) => {
//                           handleStatusUpdate(e, order);
//                         }}
//                         name="active"
//                       >
//                         Active
